...
*Most of the streaks are 0 or 1, which means he most frequently either missed a basket or made one basket before missing again. His longest streak was 4 baskets in a row*
...
*Heads came up 26 times, tails 74.*
...
*The typical streak for the independent shooter is still 0 baskets, followed by 1 basket, and two baskets. The longest streak for the independent shooter is 6 baskets in a row.*
...
*I think the distribution would be similiar but there may be variations in the distribution. 0 baskets would still be the most frequently occurring outcome, followed by 1 basket, and then two baskets, but there may be small variations in the frequencies between them. It's also possible the maximum streak length could fluctuate.*
...
*Kobe's distribution of streak lengths is less evenly distributed than the independent shooter. Kobe has almost twice as many 1 hit streaks than the independent shooter, and the independent shooter has longer streaks. This suggests Kobe's shooting streaks do not follow a "hot hand" model.*
