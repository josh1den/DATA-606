...
*Depends on the sample size. A sample this small will tend to fluctuate*
...
*For the given number of samples, 95% of the outcomes will be within the upper and lower confidence intervals*
...
*No, it captures the proportions which will be recorded in 95% of observations of the sample. Likewise, the classmates interval captures the sample as well. This is not a measure of the total population.*
...
*I expect 95% of the confidence intervals to capture the true population mean, since each confidence interval is 95% of the population sample*
...
*44/50 (0.88) confidence intervals include the true population proportion. This is not equal to the 95% confidence interval. This is because the sample size of 60 is too small*

![](/Users/joshiden/Downloads/Screen Shot 2022-10-07 at 6.27.34 PM.png)
...
*I selected an 85% confidence level, expecting there would be more intervals outside of the true population proportion, because the lower confidence level creates a wider interval.* 
...
*85% of the samples will have "Yes" responses fall between the proportions of .433 and .617*

1.  Using the app, calculate 50 confidence intervals at the confidence level you chose in the previous question, and plot all intervals on one plot, and calculate the proportion of intervals that include the true population proportion. 

How does this percentage compare to the confidence level selected for the intervals?

![](/Users/joshiden/Downloads/Screen Shot 2022-10-07 at 6.41.51 PM.png)
  
*The proportion of intervals that contain the population proportion is 42/50 (.84) -- pretty close to the 85% confidence interval*  
...
*Using a 75% confidence interval, I expect the bounds to be wider than the previous calculations.*
...
*The bounds are nearly identical. This is because the sample size is so small*
...
*The width of the confidence interval decreases as the sample size increases, and increases as the sample size decreases*
...
*The more bootstraps, the smaller the standard error, which results in a narrower width of interval*
